...
bool InitMessageHandlerROS::processMessageInit(const pronto_msgs::msg::FilterState * msg,
 ...
 * on the fly.
 */
RBISUpdateInterface * InitMessageHandlerROS::processMessage(const pronto_msgs::msg::FilterState * msg,
